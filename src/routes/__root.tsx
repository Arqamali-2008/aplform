...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "APL & ALPL Form" },
      { property: "og:title", content: "APL & ALPL Form" },
      { name: "twitter:title", content: "APL & ALPL Form" },
      { name: "description", content: "Team Sign-Up Hub is a modern, responsive system for registering sports teams." },
      { property: "og:description", content: "Team Sign-Up Hub is a modern, responsive system for registering sports teams." },
      { name: "twitter:description", content: "Team Sign-Up Hub is a modern, responsive system for registering sports teams." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bb65fa72-6c79-4c84-a8bf-09a0469ab160/id-preview-c6622ab8--818a4ad4-e00b-41b1-821e-a6c1618b0979.lovable.app-1783994217164.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bb65fa72-6c79-4c84-a8bf-09a0469ab160/id-preview-c6622ab8--818a4ad4-e00b-41b1-821e-a6c1618b0979.lovable.app-1783994217164.png" },
    ],
    links: [
